...
val pomName = "Z2 Schematic Gradle Plugin"
val pluginDescription = "Kotlin Multiplatform compiler plugin for generating schemas."
...
gradlePlugin {
    website.set("https://github.com/spxbhuhb/z2-schematic")
    vcsUrl.set("https://github.com/spxbhuhb/z2-schematic.git")
    plugins {
        create("z2schematic") {
            id = "hu.simplexion.z2.schematic"
            displayName = pomName
            description = pluginDescription
            implementationClass = "hu.simplexion.z2.schematic.gradle.SchematicGradlePlugin"
